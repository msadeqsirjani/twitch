...
namespace TwitchNightFall.Core.Migrations
{
    ...
    [Migration("20220205190102_Update-Database-6")]
            ...
            modelBuilder.Entity("TwitchNightFall.Domain.Entities.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 2, 5, 19, 1, 1, 621, DateTimeKind.Utc).AddTicks(130),
                            Firstname = "admin",
                            IsActive = true,
                            Lastname = "admin",
                            ModifiedAt = new DateTime(2022, 2, 5, 19, 1, 1, 621, DateTimeKind.Utc).AddTicks(133),
