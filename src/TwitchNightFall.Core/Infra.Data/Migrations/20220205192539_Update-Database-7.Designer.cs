...
namespace TwitchNightFall.Core.Migrations
{
    ...
    [Migration("20220205192539_Update-Database-7")]
            ...
            modelBuilder.Entity("TwitchNightFall.Domain.Entities.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 2, 5, 19, 25, 38, 838, DateTimeKind.Utc).AddTicks(955),
                            Firstname = "admin",
                            IsActive = true,
                            Lastname = "admin",
                            ModifiedAt = new DateTime(2022, 2, 5, 19, 25, 38, 838, DateTimeKind.Utc).AddTicks(958),
